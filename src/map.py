...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map('world', portals=[
            ...
            NPC('paul', pathPointsCount=4, dialog=['Bonjour !', 'Je m\'appelle Paul.', 'Bye !']),
            NPC('robin', pathPointsCount=2, dialog=['Salut ! Moi c\'est Robin.', 'J\'espère que tu t\'amuses bien !'])
        ])
        ...
        self.register_map('dungeon', portals=[
            ...
            NPC('boss', pathPointsCount=2, dialog=['MOUAHAHAHA ! Je suis le boss de ces lieux.'])
        ])
